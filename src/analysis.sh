...
# Téléchargement de la référence (.gtf)
...
# Garder les exons en un seul exemplaire car certains exons sont présents dans plusieurs transcrits du fait d'épissage alternatif et cela peut induire un biais, dans le sens où les SNPs présents dans ces exons auront un poids plus important que les SNP situés dans un exon participant à plusieurs transcrits
